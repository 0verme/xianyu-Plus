...
ensure_env UPDATE_RELEASE_API "https://api.github.com/repos/0verme/xianyu-Plus/releases/latest"
ensure_env UPDATE_GITHUB_REPOSITORY "0verme/xianyu-Plus"
...
UPDATE_RELEASE_API=https://api.github.com/repos/0verme/xianyu-Plus/releases/latest
EOF
